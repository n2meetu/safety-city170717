        ...
        dataType:"json",
            ...
            for(var i=0;i<state.menu.length;i++){
                ...
                var html=
                    ...
                    +'</td>'
                    +'<td>'
                    +'<a  data-toggle="modal" data-target="#viewpolModal" class="viewpol" onclick="view_pol_info(this.id,i)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                    +'</td>'
                    +'<td>'
                    +'<a href="#">'
                    +'<i class="fa fa-lg fa-pencil-square-o" data-toggle="modal" data-target="#viewpolModal" class="changepol" onclick="change_pol_info(this.id,i)">'
                    +'</i>'
                    +'</a>'
                    +'</td>'
                    +'<td>'
    ...
    $.ajax({
        ...
        success:function(state){
            var html='<div class="panel panel-default"  style="width:100%;text-align:center">'
                ...
                +'<td>'
                +'<a  data-toggle="modal" data-target="#viewpolModal" class="scviewpol" onclick="view_pol_info(this.id)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                +'</td>'
    ...
    $.ajax({
        ...
        success:function(state){
            var html='<div class="panel panel-default"  style="width:100%;text-align:center">'
                ...
                +'<td>'
                +'<a  data-toggle="modal" data-target="#viewpolModal" class="xcviewpol" onclick="view_pol_info(this.id)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                +'</td>'
    ...
    $.ajax({
        ...
        success:function(state){
            var html='<div class="panel panel-default"  style="width:100%;text-align:center">'
                ...
                +'<td>'
                +'<a  data-toggle="modal" data-target="#viewpolModal" class="bjviewpol" onclick="view_pol_info(this.id)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                +'</td>'
    ...
    $.ajax({
        ...
        success:function(state){
            var html='<div class="panel panel-default"  style="width:100%;text-align:center">'
                ...
                +'<td>'
                +'<a  data-toggle="modal" data-target="#viewpolModal" class="yhviewpol" onclick="view_pol_info(this.id)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                +'</td>'
    ...
    $.ajax({
        ...
        success:function(state){
            var html='<div class="panel panel-default"  style="width:100%;text-align:center">'
                ...
                +'<td>'
                +'<a  data-toggle="modal" data-target="#viewpolModal" class="xsviewpol" onclick="view_pol_info(this.id)"><i class="fa fa-lg fa-check-square-o"></i></a>'
                +'</td>'
        ...
        success:function(state){
            ...
            for(var i=0;i<state.menu.length;i++){
                ...
                var html=
                    ...
                    +'</td>'
                    +'<td>'
                    +'<a href="#"><i class="fa fa-lg fa-check-square-o" data-toggle="modal" data-target="#viewlouModal" class="mysta" onclick="view_lou_info()">'
                    +'</i>'
                    +'</a>'
                    +'</td>'
                    +'<td>'
                    +'<a href="#"><i class="fa fa-lg fa-pencil-square-o" data-toggle="modal" data-target="#viewlouModal" class="mysta" onclick="change_lou_info()">'
                    +'</i>'+'</a>'
                    +'</td>'
                    +'<td>'
                    +'<a href="#"><i class="fa fa-lg fa-times-rectangle-o" onclick="deletesta()">'
                    +'</i>'
                    +'</a>'
                    +'</a>'
                    +'</td>'
